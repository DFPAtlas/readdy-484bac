...
const PAYMENT_STATUS_MAP: Record<string, { label: string; variant: BadgeVariant; icon: string }> = {
  ...
  payout_pending: { label: 'Payout Pending', variant: 'warning', icon: 'ri-hourglass-line' },
  payout_processing: { label: 'Payout Processing', variant: 'info', icon: 'ri-loader-4-line' },
  paid_out: { label: 'Paid Out', variant: 'success', icon: 'ri-check-double-line' },
