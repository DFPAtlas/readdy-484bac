...
const statusConfig: Record<string, { bg: string; text: string; border: string; icon: string; label: string }> = {
  ...
  review_pending: { bg: 'bg-amber-500/10', text: 'text-amber-400', border: 'border-amber-500/25', icon: 'ri-star-line', label: 'Review Pending' },
  closed: { bg: 'bg-slate-500/10', text: 'text-slate-400', border: 'border-slate-500/25', icon: 'ri-checkbox-circle-line', label: 'Closed' },
