        ...
        >
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <Link href="/client/forgot-password" className="text-xs text-[#1DA1F2] hover:text-[#3B82F6] underline mt-1 inline-block">
    ...
    <div className="relative flex-1 flex items-center justify-center p-6 lg:p-12 overflow-y-auto">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <LoginFormCard
          ...
          formId="client-reset-password-form"
