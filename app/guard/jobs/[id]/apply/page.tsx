...
import GuardApplyClient from './GuardApplyClient';
...
export default async function GuardApplyPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
  return <GuardApplyClient jobId={id} />;
}